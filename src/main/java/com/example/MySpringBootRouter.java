...
public class MySpringBootRouter extends RouteBuilder {
    ...
    public void configure() throws Exception {
    	...
    	String erpUri = "https://5298967.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=6&deploy=1";
		...
		//from("timer:poll?period={{timer.period}}&delay=").routeId("{{route.id}}")
    	from("timer:poll?period={{timer.period}}&delay=24840000").routeId("{{route.id}}")
    		.process(exchange -> {
